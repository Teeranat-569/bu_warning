...
class ShowIdWarningMTN extends StatefulWidget {
  @override
  _ShowIdWarningMTNState createState() => _ShowIdWarningMTNState();

  final WarningModel warningModel;
  ShowIdWarningMTN({Key key, this.warningModel}) : super(key: key);
}

class _ShowIdWarningMTNState extends State<ShowIdWarningMTN> {
  bool loadStatus = true;
  bool status2, valued;
  String nameForm, agency, phone, time, rate, buildKK, floor, numRoom, moreForm;
  String dateTimeWarning, dateEnd, timeEnd,comment;
  String idWarning;
  String buildForm;
  String airForm;
  String status;
    ...
    try {
      ...
      for (var map in result) {
        ...
        setState(() {
          ...
          buildKK = warningModel.buildKk;
          floor = warningModel.floorsPp;
  ...
  Future<Null> updateStatus() async {
    ...
    var dateTimeWarningg = DateFormat.yMMMMEEEEd();
    dateTimeWarningEnd =
        dateTimeWarningg.formatInBuddhistCalendarThai(dateTime);
    print('//////////////////////////////////////////////////////////////////' +
        dateTimeWarningEnd);
    String url =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: [loadStatus ? MyStyle().showProgressMTN() : showContent()],
        ),
      ),
    );
  }
