...
class Numroom extends StatefulWidget {
  @override
  _NumroomState createState() => _NumroomState();
}

class _NumroomState extends State<Numroom> {
                  ...
                  IconButton(
                      onPressed: () {
                        MaterialPageRoute materialPageRoute = MaterialPageRoute(
                            builder: (BuildContext context) => Numroom());
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        return Container(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text('ลำดับห้อง ${catebuildingModels[index].numRoom}'),
            ));
      },
        ...
        onPressed: () {
          if (buildingStr == null || buildingStr.isEmpty) {
            ...
            MaterialPageRoute materialPageRoute =
                MaterialPageRoute(builder: (BuildContext context) => Numroom());
  ...
  Future<Null> addBuildingThread() async {
    String url =
        '${Myconstant().domain}/appkk/addDatahouse_buildKK.php?isAdd=true&build_kk='
        '&floorspp='
        '&numRoom=$buildingStr';
    try {
